...
const DoctorProfileEdit = () => {
  ...
  // Pre-filled with existing data (in real app, this would come from API/database)
  ...
  const [selectedDays, setSelectedDays] = useState<string[]>(["mon", "tue", "wed", "fri"]);
  ...
  const handleChange = (field: keyof DoctorProfileForm, value: string) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Profile Updated:", submissionData);
    toast({
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button type="button" variant="outline" asChild className="flex-1">
                      <Link to="/doctor/dashboard">Cancel</Link>
                    </Button>
                  </div>
                </form>
              </CardContent>
